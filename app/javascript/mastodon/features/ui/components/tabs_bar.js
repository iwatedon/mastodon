...
export const links = [
  ...
  <NavLink className='tabs-bar__link' exact to='/tags/gochisou_photo' data-preview-title-id='column.gochisou' data-preview-icon='cutlery' ><Icon id='cutlery' fixedWidth /><FormattedMessage id='tabs_bar.gochisou_timeline' defaultMessage='Gochisou' /></NavLink>,
