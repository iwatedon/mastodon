...
export const links = [
  ...
  <NavLink className='tabs-bar__link' exact to='/tag/gochisou_photo' data-preview-title-id='column.gochisou' data-preview-icon='hashtag' ><Icon id='hashtag' fixedWidth /><FormattedMessage id='tabs_bar.gochisou_timeline' defaultMessage='Gochisou' /></NavLink>,
