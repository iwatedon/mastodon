...
const NavigationPanel = () => (
  <div className='navigation-panel'>
    ...
    <NavLink className='column-link column-link--transparent' to='/tags/gochisou_photo' data-preview-title-id='column.gochisou' data-preview-icon='cutlery' ><Icon className='column-link__icon' id='cutlery' fixedWidth /><FormattedMessage id='tabs_bar.gochisou_timeline' defaultMessage='gochisou_photo' /></NavLink>
