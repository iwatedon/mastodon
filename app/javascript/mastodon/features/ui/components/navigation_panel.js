...
const NavigationPanel = () => (
  <div className='navigation-panel'>
    ...
    <NavLink className='column-link column-link--transparent' to='/tag/gochisou_photo' data-preview-title-id='column.gochisou' data-preview-icon='hashtag' ><Icon className='column-link__icon' id='hashtag' fixedWidth /><FormattedMessage id='tabs_bar.gochisou_timeline' defaultMessage='gochisou_photo' /></NavLink>
