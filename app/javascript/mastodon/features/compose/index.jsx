        ...
        <div className='drawer' role='region' aria-label={intl.formatMessage(messages.compose)}>
          <nav className='drawer__header'>
            ...
            {!columns.some(column => (column.get('id') === 'HASHTAG' && column.get('params').get('id') === 'gochisou_photo')) && (
              <Link to='/tags/gochisou_photo' className='drawer__tab' title={intl.formatMessage(messages.gochisou)} aria-label={intl.formatMessage(messages.gochisou)}><Icon id='cutlery' icon={RestaurantIcon} /></Link>
            )}
