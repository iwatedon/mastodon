...
class User < ApplicationRecord
  ...
  delegate :auto_play_gif, :default_sensitive, :unfollow_modal, :boost_modal, :delete_modal,
           ...
           :disable_swiping, :always_send_emails, :x_only_media_on_home_timeline,
  ...
  def regenerate_feed!
    if redis.set("account:#{account_id}:regeneration", true, nx: true, ex: 1.day.seconds) && redis.set("account:#{account_id}:media:regeneration", true, nx: true, ex: 1.day.seconds)
